#!/bin/bash
# Assembles MusicWidget.app from a SwiftPM build.
#
...
# dist/MusicWidget-Debug.app. Used by Tests/MusicWidgetUITests: the debug
...
if [[ "$CONFIG" == "debug" ]]; then
    ...
    # real install of the app under its normal com.shazibid.MusicWidget ID.
    plutil -replace CFBundleIdentifier -string "com.shazibid.MusicWidget.debug" "$APP_BUNDLE/Contents/Info.plist"
fi
